...
namespace CaroAIServer.Migrations
{
    ...
    [Migration("20250529153451_AddPlayerToMoveToOpeningPosition")]
    partial class AddPlayerToMoveToOpeningPosition
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CaroAIServer.Data.OpeningPosition", b =>
                {
                    ...
                    b.Property<int>("PlayerToMove")
                        .HasColumnType("int")
                        .HasColumnName("player_to_move");
